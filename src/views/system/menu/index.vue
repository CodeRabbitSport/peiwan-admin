...
/** 添加/修改操作 */
const formRef = ref()
function openForm(type: string, id?: number, parentId?: number) {
...
async function handleStatusChanged(menu: MenuVO, val: number) {
  // 1. 标记 menu.id 更新中
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <ElButton plain type="danger" @click="toggleExpandAll">
          <Icon class="mr-5px" icon="ep:sort" />
          展开/折叠
        </ElButton>
        <ElButton plain @click="refreshMenu">
          <Icon class="mr-5px" icon="ep:refresh" />
          刷新菜单缓存
        </ElButton>
      </el-form-item>
