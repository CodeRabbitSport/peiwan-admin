...
<template>
  <Dialog v-model="dialogVisible" title="发送通知" :max-height="500">
    <el-form
      ref="formRef"
    ...
    >
      ...
      <el-form-item v-show="formData.userType === 1" label="接收人ID" prop="userId">
        ...
        <!-- <UserSelectInput v-model="formData.userId" readonly placeholder="请选择接收人" /> -->
        <UserMultiSelectInput v-model="formData.userId" placeholder="请选择接收人(多选)" />
      </el-form-item>
