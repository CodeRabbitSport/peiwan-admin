...
import type { UserMomentRedPacket } from '@/api/gamer/usermomentredpacket'
import { UserMomentRedPacketApi } from '@/api/gamer/usermomentredpacket'
...
function handleRowCheckboxChange(records: UserMomentRedPacket[]) {
