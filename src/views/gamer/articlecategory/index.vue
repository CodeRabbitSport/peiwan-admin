<template>
    ...
    <el-form
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['gamer:article-category:create']"
          class="mb-2 sm:mb-0">
        ...
        <el-button
          ...
          v-hasPermi="['gamer:article-category:export']"
          class="mb-2 sm:mb-0">
        ...
        <el-button
          ...
          v-hasPermi="['gamer:article-category:delete']"
          class="mb-2 sm:mb-0">
  ...
  <ContentWrap>
    <el-table
      ...
      <el-table-column label="分类目录名称" align="center" prop="categoryName" />
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        ...
        <template #default="scope">
          ...
          <el-button
            ...
            v-hasPermi="['gamer:article-category:update']">
            编辑
          </el-button>
          <el-button
            link
...
import ArticleDialog from '../article/ArticleDialog.vue'
...
const list = ref<ArticleCategory[]>([]) // 列表的数据
...
const openArticleDialog = (category: ArticleCategory) => {
  articleDialogRef.value.open(category)
}
...
const handleDeleteBatch = async () => {
  try {
    // 删除的二次确认
    await message.delConfirm()
    await ArticleCategoryApi.deleteArticleCategoryList(checkedIds.value);
    checkedIds.value = [];
    message.success(t('common.delSuccess'))
    await getList();
  } catch { }
...
const handleRowCheckboxChange = (records: ArticleCategory[]) => {
