<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" align-center	>
    ...
    >
      <el-form-item label="分类目录名称" prop="categoryName">
        <el-input v-model="formData.categoryName" placeholder="请输入分类目录名称" />
      </el-form-item>
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    const data = formData.value as unknown as ArticleCategory
