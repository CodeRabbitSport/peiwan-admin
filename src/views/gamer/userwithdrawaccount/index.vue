<template>
    ...
    >
      ...
      <el-form-item label="提现渠道(1微信收款 2支付宝收款 3银行卡收款 4支付宝账号收款)" prop="channel">
        <el-select
          ...
          placeholder="请选择提现渠道(1微信收款 2支付宝收款 3银行卡收款 4支付宝账号收款)"
          clearable
          class="!w-240px"
        >
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      ...
      <el-table-column label="是否默认账户 0否 1是" align="center" prop="isDefault" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
...
import { UserWithdrawAccountApi, UserWithdrawAccount } from '@/api/gamer/userwithdrawaccount'
...
const handleRowCheckboxChange = (records: UserWithdrawAccount[]) => {
