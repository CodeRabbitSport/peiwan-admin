...
import type { Conversation } from '@/api/gamer/conversation'
import { ConversationApi } from '@/api/gamer/conversation'
import download from '@/utils/download'
import { dateFormatter } from '@/utils/formatTime'
import ConversationMessage from '@/views/gamer/conversationmessage/index.vue'
...
function openRecords(row: Conversation) {
...
function handleRowCheckboxChange(records: Conversation[]) {
...
<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          v-hasPermi="['gamer:conversation:delete']"
          type="danger"
          plain
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <!-- <el-button
            ...
            v-hasPermi="['gamer:conversation:update']"
          >
            编辑
          </el-button> -->
          <el-button
  ...
  <el-dialog v-model="recordDialogVisible" title="会话记录" width="80%">
    <ConversationMessage :embed="true" :conversation-id="recordConversationId" />
  </el-dialog>
