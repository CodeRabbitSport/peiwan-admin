<template>
    ...
    >
      ...
      <el-form-item label="退款状态(0-待审核,1-已通过,2-已拒绝)" prop="status">
        <el-select
          ...
          placeholder="请选择退款状态(0-待审核,1-已通过,2-已拒绝)"
          clearable
          class="!w-240px"
        >
          <el-option label="请选择字典生成" value="" />
      ...
      <el-form-item label="转账状态(0-未转账,1-已转账)" prop="transferStatus">
        <el-select
          ...
          placeholder="请选择转账状态(0-未转账,1-已转账)"
          clearable
          class="!w-240px"
        >
          <el-option label="请选择字典生成" value="" />
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      <el-table-column label="退款单ID" align="center" prop="id" />
      ...
      <el-table-column
        ...
        width="180px"
      />
      <el-table-column label="退款保证金金额(分)" align="center" prop="transactionAmount" />
      <el-table-column
        label="预计自动退款时间 = 审核通过时间 + wait_days"
        align="center"
        prop="autoTransferredAt"
        :formatter="dateFormatter"
        width="180px"
      />
      <el-table-column label="是否人工提前退款 0否 1是" align="center" prop="isManualTransferred" />
      <el-table-column label="退款状态(0-待审核,1-已通过,2-已拒绝)" align="center" prop="status" />
      <el-table-column
        label="审核通过时间"
        align="center"
        prop="approvedAt"
        ...
        width="180px"
      />
      <el-table-column label="退款等待天数(冗余保存配置，如33)" align="center" prop="waitDays" />
      <el-table-column label="转账状态(0-未转账,1-已转账)" align="center" prop="transferStatus" />
...
const handleRowCheckboxChange = (records: DepositTransfer[]) => {
