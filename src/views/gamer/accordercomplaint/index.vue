...
async function handleDeleteBatch() {
  try {
    ...
    await AccOrderComplaintApi.deleteAccOrderComplaintList(checkedIds.value)
    checkedIds.value = []
...
async function handleExport() {
  try {
    ...
    const data = await AccOrderComplaintApi.exportAccOrderComplaint(queryParams)
    download.excel(data, '陪玩订单投诉内容.xls')
  }
  catch {
  }
  finally {
