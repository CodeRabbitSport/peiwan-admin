<template>
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      ...
      <el-table-column label="名片信息(JSON字符串)" align="center" prop="cardInfo" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
...
const handleRowCheckboxChange = (records: UserPlayerCard[]) => {
...
const handleExport = async () => {
  try {
    ...
    const data = await UserPlayerCardApi.exportUserPlayerCard(queryParams)
    download.excel(data, '用戶游戏名片.xls')
  } catch {
  } finally {
