...
const formData = ref({
  ...
  remark: undefined,
  orderNotifyUrl: "http://localhost/admin-api/pay/notify/order",
  refundNotifyUrl: "http:///localhost/admin-api/pay/notify/refund",
...
async function submitForm() {
  ...
  try {
    ...
    data.appKey = 'MPay'
    data.name = 'MPay'
    data.orderNotifyUrl = "http://localhost/admin-api/pay/notify/order"
    data.refundNotifyUrl = "http:///localhost/admin-api/pay/notify/refund"
