<template>
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      ...
      <el-table-column label="等级编号" align="center" prop="levelNumber" />
      <el-table-column label="等级名称" align="center" prop="levelName" />
      <el-table-column label="等级图标" align="center" prop="levelIcon" />
      <el-table-column label="等级封面" align="center" prop="levelCover" />
      <el-table-column label="等级描述" align="center" prop="levelDescription" />
      <el-table-column label="等级权益(存json)" align="center" prop="levelPrivileges" />
...
const handleRowCheckboxChange = (records: UserGrade[]) => {
