...
export const useRenderLayout = () => {
  ...
  const renderTopLeft = () => {
    return (
      <>
        <div class="relative flex items-center bg-[var(--left-menu-bg-color)] layout-border__bottom">
  ...
  const renderTop = () => {
    return (
      <>
        <div
          class={[
            'flex items-center justify-between bg-[var(--left-menu-bg-color)] relative',
            {
              'layout-border__bottom': !tagsView.value
            }
          ]}
